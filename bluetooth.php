...
<body>
  ...
  <h1>Bluetooth on Raspi 4</h1>
 
<p>The main concern is to connect with Polar H10 chest band and collect the HR and HRV data from there. Thus, we use the <a href="https://pypi.org/project/bleak/">Bleak</a> client service.</p>


<h2>Read the notification</h2>
<pre><code>
"""
Notifications
-------------
...
<p>Pair the device with the MAC address. 




<p><a href="https://github.com/polarofficial/create-mobile-app-for-polar-sensors">Polar Official Github. Create a Mobile App</a>: 
 ...
 the Sensor will start termination of BLE connection and switches back to standby mode to save power.</p>




<p><a href="https://github.com/polarofficial/polar-ble-sdk">Polar Official Github: Ble sdk</a>:
 H10 Heart rate sensor
 Most accurate Heart rate sensor in the markets.

 H10 heart rate sensor available data types</p>
 <ul>
 <li>From version 3.0.35 onwards.</li>
 <li>Heart rate as beats per minute. RR Interval in ms and 1/1024 format.</li>
 <li>Electrocardiography (ECG) data in µV. Default epoch for timestamp is 1.1.2000</li>
 <li>Accelerometer data with samplerates of 25Hz, 50Hz, 100Hz and 200Hz and 
  range of 2G, 4G and 8G. Axis specific acceleration data in mG. 
  Default epoch for timestamp is 1.1.2000</li>
  <li>Start and stop of internal recording and request for internal recording status. 
  Recording supports RR, HR with one second sampletime or HR with five second sampletime.</li>
  <li>List, read and remove for stored internal recording 
  (sensor supports only one recording at the time). </li>
</ul>
...
<h4>Heart Rate </h4>
<p>The heart rate measurement values looks the following, BUT there is a big problem as the values are not INT as depicted here. Actually the values are BINARY data that needs to be interpreted correct.</p>
